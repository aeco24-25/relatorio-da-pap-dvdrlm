              ...
              <div class="row">
                ...
                <div class="col-lg-12">
                  <fieldset>
                    ...
                    <label class="container" style="width: 125px;px; --color: #d6d1f3; height:25px; --size: 30px; display: flex;justify-content: right; margin-top: -67px; margin-left: 445px; font-size: var(--size); fill: var(--color);">
                        <input style="height: 23px; width:35%; opacity:0;"type="checkbox" id="togglePassword">
