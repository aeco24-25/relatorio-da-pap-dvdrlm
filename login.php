    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
				<!-- ***** Logo Start ***** -->
				<img src="assets/images/logo.png" href="./login.php" class="header-image" style=" margin-left: 45px; width: 165px; margin-right: 13px; object-fit: contain; "alt="DTeaches Logo"><a href="index.php" class="logo">
					<h1>DTeaches</h1>
				</a>
				<!-- ***** Logo End ***** -->
				<!-- ***** Menu Start ***** -->
				<ul class="nav">
					<li class="scroll-to-section"><a href="#contact">COMEÇAR JÁ</a></li>
          <li class="scroll-to-section"><a href="./login.php">ENTRAR</a></li>
				</ul>   
